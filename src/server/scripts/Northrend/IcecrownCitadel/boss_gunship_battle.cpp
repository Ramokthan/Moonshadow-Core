...
#define GO_ALLIANCE_GUNSHIP_PORTAL			195371	// ¿ Útiles ?
...
#define GO_HORDE_GUNSHIP_PORTAL				196413	// ¿ Útil ?
...
// MURADIN BARBABRONCE// ALTO_SEÑOR_SUPREMO_COLMILLOSAURIO
		...
		bool OnGossipSelect(Player* player, Creature* pCreature, uint32 /*sender*/, uint32 action)
		{
			...
			switch( action) {
				case	ALLIANCE_GOSSIP_ACTION_START	:
							pCreature->AI()->DoAction( DO_ACTION_START_GUNSHIP_BATTLE); // lancement de la cannonière !
							return true;
				case	ALLIANCE_GOSSIP_ACTION_TP		:
							pCreature->AI()->DoAction( DO_ACTION_FINISH_GUNSHIP_BATTLE); // après fin de la cannonière !
							return true;
...
class boss_muradin_bronzebeard : public CreatureScript
{
    public:
					...
					if( dialogTimer <= diff) {
						...
						// EMBARQUE_EVENTO
							...
							case	10	:
								...
								break;
							case	11	:
								// ¡ COMIENZO DE LA BATALLA DE LOS CAÑONES !
								this->Start();
								break;
						};
		...
		bool OnGossipSelect(Player* player, Creature* pCreature, uint32 /*sender*/, uint32 action)
		{
			...
			switch( action) {
				case	ALLIANCE_GOSSIP_ACTION_START	:
							pCreature->AI()->DoAction( DO_ACTION_START_GUNSHIP_BATTLE); // ¡ Lanzamiento de los Cañones !
							return true;
				case	ALLIANCE_GOSSIP_ACTION_TP		:
							pCreature->AI()->DoAction( DO_ACTION_FINISH_GUNSHIP_BATTLE); // ¡ Fin de los cañones !
							return true;
				case	ALLIANCE_GOSSIP_ACTION_CANCEL	:
							return true;
			};
