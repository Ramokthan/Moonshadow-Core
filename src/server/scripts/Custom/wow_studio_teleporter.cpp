...
//Geschrieben für WoW-Studio.net

#include "ScriptPCH.h"
#include <cstring>


class wow_studio_teleporter : public CreatureScript
{
    public:

        wow_studio_teleporter()
            : CreatureScript("wow_studio_teleporter")
        {
        }
		...
		void MainMenu(Player* player, Creature* creature)
		{
			...
			player->ADD_GOSSIP_ITEM(2, "Ã–stliche K\303\266nigreiche Instanzen",              GOSSIP_SENDER_MAIN,   3);
        ...
        { 
			...
			if (action == 1)
			{
				...
				player->ADD_GOSSIP_ITEM(0, "Hauptmen\303\274",                 GOSSIP_SENDER_MAIN,   9);
            ...
            player->ADD_GOSSIP_ITEM(2, "H\303\274gel der Klingenhauer",              GOSSIP_SENDER_MAIN,  20);
            player->ADD_GOSSIP_ITEM(2, "Kral der Klingenhauer",                      GOSSIP_SENDER_MAIN,  21);
            ...
            player->ADD_GOSSIP_ITEM(2, "Zul Farrak",                                 GOSSIP_SENDER_MAIN,  30);
			player->ADD_GOSSIP_ITEM(0, "Hauptmen\303\274",                           GOSSIP_SENDER_MAIN,   9);
			player->ADD_GOSSIP_ITEM(0, "Bye",                                        GOSSIP_SENDER_MAIN, 100);
			player->PlayerTalkClass->SendGossipMenu(DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
			};
		...
		if (action == 7)
			...
			player->ADD_GOSSIP_ITEM(2, "Seelenschmiede",                       GOSSIP_SENDER_MAIN, 114);
			player->ADD_GOSSIP_ITEM(2, "Grube von Saron",                      GOSSIP_SENDER_MAIN, 114);
			player->ADD_GOSSIP_ITEM(2, "Halle der Reflexionen",                GOSSIP_SENDER_MAIN, 114);
			player->ADD_GOSSIP_ITEM(0, "Hauptmen\303\274",                     GOSSIP_SENDER_MAIN,   9);
			player->ADD_GOSSIP_ITEM(0, "Bye",                                  GOSSIP_SENDER_MAIN, 100);
			player->PlayerTalkClass->SendGossipMenu(DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
			};
		...
		if (action == 9)
		{
			...
			if (action == 16)
			{
				player->CLOSE_GOSSIP_MENU(); player->TeleportTo(1,     1629.777344f,  -4373.210449f,     31.246769f, 0.000000f);
			}
			if (action == 17)
			{
			...
			if (action == 20)
			{
				player->CLOSE_GOSSIP_MENU(); player->TeleportTo(1,		-4658.329590f,	-2526.060371f,	81.519173f,	4.070045f);
			}
			if (action == 21)
			{
				player->CLOSE_GOSSIP_MENU(); player->TeleportTo(1,		-4465.553711f,	-1668.173340f,	81.895256f,	0.751732f);
			}
			if (action == 23)
			{
			...
			if (action == 115)
			{
				player->CLOSE_GOSSIP_MENU(); player->TeleportTo(571,     4398.571289f, 6156.057129f,    0.237823f, 2.182381f);
			}
			if (action == 116)
			{
				player->CLOSE_GOSSIP_MENU(); player->TeleportTo(0,     -13332.613281f, 136.379059f,    18.849024f, 5.006504f);
			}
			if (action == 200)
			{
				player->CLOSE_GOSSIP_MENU();
